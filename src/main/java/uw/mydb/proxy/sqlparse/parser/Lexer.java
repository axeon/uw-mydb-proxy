package uw.mydb.proxy.sqlparse.parser;

import java.util.ArrayList;
import java.util.Arrays;
import java.util.List;

import static uw.mydb.proxy.sqlparse.parser.CharTypes.*;
import static uw.mydb.proxy.sqlparse.parser.LayoutCharacters.EOI;
